      ...
      <div className='w-full screen-max-width sec-x-padding'>
        <div className='w-full border-[1px] border-secondary-light rounded-2xl pt-14 pb-10 px-10 xl:px-14'>
          <div className='w-full pb-12 border-b-[0.7px] border-secondary-main/40'>
            ...
            <div className='mt-6 flex w-full flex-col text-muted-light gap-3 md:flex-row md:justify-between md:items-center'>
          ...
          <div className='w-full pt-8 flex flex-col gap-7 md:gap-4 md:flex-row md:items-center md:justify-between'>
            ...
            {/* Credit */}
            <div className='flex flex-col items-center justify-center md:justify-end md:items-end gap-0.5 text-muted-light text-[0.7rem] text-right'>
